...
fun Calculator(modifier: Modifier = Modifier) {
    ...
    var numeroMemoria by remember { mutableIntStateOf(0) }
        ...
        memoryButtons(
           ...
           mAddOnClick = {
                if (result.isNotEmpty()){
                    val nuevoNumero = result.toInt()
                    numeroMemoria = numeroMemoria + nuevoNumero
                }
           },
           mSubtracOnClick = {
                if (numeroMemoria != 0){
                    val ultimoNumeroEnMemoria = result.toInt()
                    numeroMemoria = numeroMemoria - ultimoNumeroEnMemoria
                }
...
@Composable
fun memoryButtons (mClearOnClick: () -> Unit,
                   mRecallOnClick: () -> Unit,
                   mAddOnClick:  () -> Unit,
                   mSubtracOnClick: () -> Unit, modifier : Modifier = Modifier){
    Row {
        Button(
            onClick = {
                mClearOnClick()
...
@Preview
@Composable
fun memoryButtonsPreview (){
    PracticaCalculadoraTheme {
        Column {
            memoryButtons(mClearOnClick = {}, mRecallOnClick = {}, mAddOnClick = {}, mSubtracOnClick = {})
        }
    }
}
